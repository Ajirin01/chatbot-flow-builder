<template>
  <div>
    ...
    <button class="waves-effect waves-light btn" @click="assignNextMessage">Assign Re-run Message</button>
  </div>
</template>
  ...
  methods: {
    ...
    assignNextMessage() {
      if (this.selectedMessage) {
        this.selectedObject.rerun = this.selectedMessage.id;
        console.log("Assigned rerun message:", this.selectedMessage);
        // Reset selections
